<div class="row mt-3 pe-4" style="width:100%">
    <div class="col-lg-3" style="position: relative;">
        <nav id="sidebar" class="mt-5 rounded" style="position: fixed;">
            <div class="p-4">
                <div class="d-flex">
                    <img src="<?= base_url("assets/img/profile.jpg"); ?>" class="rounded-circle" alt="" width="80" height="80">
                    <div class="ms-3 pt-2">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="mb-2 dropdown-produk">
                        ...
                        <a class="dropdown-toggle text-decoration-none fw-bold text-dark" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                            Produk
                        </a>
                        <div class="collapse" id="collapseExample">
                            <div class="">
                                <ul>
                                    <li>
                                        <a href="<?= base_url("toko/tambah"); ?>" class="text-decoration-none text-dark">Tambah Produk</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url("toko/produk"); ?>" class="text-decoration-none text-dark">Daftar Produk</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li>
                        <i class="fas fa-box-open"></i>
                        <a class="dropdown-toggle text-decoration-none fw-bold text-dark" data-bs-toggle="collapse" href="#pesanan" role="button" aria-expanded="false" aria-controls="collapseExample">
                            Pesanan
                        </a>
                        <div class="collapse" id="pesanan">
                            <div class="">
                                <ul>
                                    <li>
                                        <a href="<?= base_url("toko/pesanan"); ?>" class="text-decoration-none text-dark">Pesanan Saya</a>
                                    </li>
                                    <li>
                                </ul>
                            </div>
